...
def PCE_prediction(population):
    ...
    for x in range(len(population)):
        ...
        exists = os.path.isfile('PCE_predictions_GA3/%s.txt' % (filename))
        if exists:
            with open('PCE_predictions_GA3/%s.txt' % (filename), 'r') as file:
            ...
            for i in range(len(donors)):
                ...
                with open('PCE_predictions_GA3/%s.txt' % (filename), 'w') as file:
