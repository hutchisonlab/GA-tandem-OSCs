...
def make_NFA_str(temp_NFA, unit_list):
    ...
    SMILES = unit_list[0].iloc[left_term][1] +unit_list[3].iloc[left_spacer][1]+ unit_list[3].iloc[core][1] + unit_list[3].iloc[right_spacer][1] + unit_list[2].iloc[right_term][1]
