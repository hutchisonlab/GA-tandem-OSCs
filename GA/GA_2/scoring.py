...
def PCE_prediction(population):
    ...
    for x in range(len(population)):
        ...
        exists = os.path.isfile('PCE_predictions_GA2/%s.txt' % (filename))
        if exists:
            with open('PCE_predictions_GA2/%s.txt' % (filename), 'r') as file:
            ...
            if exists:
                ...
                best_PCE = 0
                best_donor = 'None-bad molecule'

            with open('PCE_predictions_GA2/%s.txt' % (filename), 'w') as file:
