...
def fitness_prediction(population, unit_list):
    ...
    best_don_abs_filename = '../GA1234/don_abs_csvs_smear08/260_99_101111_abs.csv'
    ...
    for x in range(len(population)):
        ...
        exists = os.path.isfile('predictions_GA6/%s.txt' % (filename))
        if exists:
            with open('predictions_GA6/%s.txt' % (filename), 'r') as file:
            ...
            with open('predictions_GA6/%s.txt' % (filename), 'w') as file:
