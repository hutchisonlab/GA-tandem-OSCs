...
def fitness_prediction(population, unit_list):
    ...
    best_acc_abs_filename = '../GA1234/acc_abs_csvs_smear12/39_126_39_abs.csv'
    best_don_abs_filename = '../GA1234/don_abs_csvs_smear12/100_99_111101_abs.csv'
    ...
    for x in range(len(population)):
        ...
        exists = os.path.isfile('predictions_GA5_smear12/%s.txt' % (filename))
        if exists:
            with open('predictions_GA5_smear12/%s.txt' % (filename), 'r') as file:
            ...
            acc_abs_filename = '../GA1234/acc_abs_csvs_smear12/' + acceptor_name + '_abs.csv'
            don_abs_filename = '../GA1234/don_abs_csvs_smear12/' + donor_name + '_abs.csv'
            ...
            #score = ((combined_abs-314.92)/300.91) - ((overlap-75.74)/245.95)

            # standardized
            #score = ((combined_abs-449.404)/48.1159) - ((overlap-171.3718)/38.336)

            with open('predictions_GA5_smear12/%s.txt' % (filename), 'w') as file:
