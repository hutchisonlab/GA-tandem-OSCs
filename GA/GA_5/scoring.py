...
def fitness_prediction(population, unit_list):
    ...
    best_acc_abs_filename = '../GA1234/acc_abs_csvs_smear04/39_126_39_abs.csv'
    best_don_abs_filename = '../GA1234/don_abs_csvs_smear04/100_99_111101_abs.csv'
    ...
    for x in range(len(population)):
        ...
        exists = os.path.isfile('predictions_GA5_smear04/%s.txt' % (filename))
        if exists:
            with open('predictions_GA5_smear04/%s.txt' % (filename), 'r') as file:
            ...
            acc_abs_filename = '../GA1234/acc_abs_csvs_smear04/' + acceptor_name + '_abs.csv'
            don_abs_filename = '../GA1234/don_abs_csvs_smear04/' + donor_name + '_abs.csv'
            ...
            with open('predictions_GA5_smear04/%s.txt' % (filename), 'w') as file:
